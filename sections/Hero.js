    ...
    <>
      <section className='hero'>
        <div className='container'>
          ...
          <h1 className='hero-title'>Welcome to MR Deva</h1>
          <TitleSm title='MR Deva International is your trusted partner for comprehensive consultancy and advisory services across multiple domains.' />
